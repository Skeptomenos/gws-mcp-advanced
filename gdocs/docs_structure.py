...
def get_table_cell_indices(doc_data: dict[str, Any], table_index: int = 0) -> list[list[tuple[int, int]]] | None:
    """
...
def find_element_at_index(doc_data: dict[str, Any], index: int) -> dict[str, Any] | None:
    """
