...
This module provides MCP tools for managing comments on Google Workspace files.
All Google Workspace apps (Docs, Sheets, Slides) use the Drive API for comment operations.

NOTE: This module was relocated from core/comments.py to gdocs/ per Phase 1.2 refactoring.
The create_comment_tools factory is shared by gsheets and gslides modules.
"""
...
# Create the document comment tools for gdocs module
